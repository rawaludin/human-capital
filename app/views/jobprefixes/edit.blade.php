...
@section('breadcrumb')
    ...
    <li class="active">Perbaharui Job Prefix</li>
@stop

@section('content')
    <div class="m-b-md">
        <h3 class="m-b-none">Perbaharui Job Prefix</h3>
    </div>
    ...
    {{ Form::model($jobprefix, array('url' => route('jobprefixes.update', $jobprefix->id), 'method' => 'put',
