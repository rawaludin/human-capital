...
@section('breadcrumb')
    ...
    <li class="active">Perbaharui Job Title</li>
@stop

@section('content')
    <div class="m-b-md">
        <h3 class="m-b-none">Perbaharui Job Title</h3>
    </div>
    ...
    {{ Form::model($jobtitle, array('url' => route('jobtitles.update', $jobtitle->id), 'method' => 'put',
